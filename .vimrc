...
if s:is_mac
  nnoremap [Space]m yiwq:vimShellInteractive<Space>say<Space>"<C-r>*"<CR>
endif
...
nmap <Leader>a :<C-u>Ref webdict alc<Space>
nmap <Leader>w yiw:<C-u>Ref webdict alc<Space><C-r>*<CR>
...
nnoremap <silent> [Tag]q :tabclose<CR>
nnoremap <silent> [Tag]k :tabnext<CR>
nnoremap <silent> [Tag]j :tabprevious<CR>
"}}}
